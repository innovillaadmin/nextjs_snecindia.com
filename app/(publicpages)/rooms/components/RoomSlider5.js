...
export default function RoomSlider5() {
  ...
  return (
    <div className="container-fluid pt-3 pb-3">
      <h1 className="bebas-neue-regular text-center py-5">Room 5</h1>
        ...
        <div className="row m-0">
            ...
            >
              <div className="border  keen-slider__slide rounded number-slide4 ">
                ...
                <Image
                  ...
                  src={"/assets/img/gallery/IMG_5413.webp"}
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide1">
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src={"/assets/img/gallery/IMG_5428.webp"}
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide2 ">
                ...
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src={"/assets/img/gallery/IMG_5416.webp"}
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide3 ">
                ...
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src={"/assets/img/gallery/IMG_5414.webp"}
                />
              </div>
            </div>
          ...
          <div className="col-md-6 bg-dark rounded mt-1 p-1">
            <div className="px-2 py-2 px-md-5 py-md-4">
              ...
              <h1 className="text-white mb-4">Experience Ultimate Elegance</h1>
              <p className="text-white mb-4">
                Step into a world of elegance where every room offers
                unparalleled comfort, from chic design to thoughtful amenities
              ...
              <BtnBookThisRoom roomid={"5"} key={5} roomdata={roomdata} />
            </div>
          </div>
        </div>
      </div>
