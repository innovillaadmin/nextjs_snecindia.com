...
export default function RoomSlider3() {
  ...
  return (
    <div className="container-fluid pt-3 pb-3">
      <h1 className="bebas-neue-regular text-center py-5">Room 2</h1>
        ...
        <div className="row m-0">
            ...
            >
              <div className="border  keen-slider__slide rounded number-slide1">
                <Image
                  ...
                  src={"/assets/img/gallery/IMG_5372.webp"}
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide2 ">
                ...
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src={"/assets/img/gallery/IMG_5373.webp"}
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide3 ">
                ...
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src={"/assets/img/gallery/IMG_5374.webp"}
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide4 ">
                ...
                <Image
                  width={500}
                  height={500}
                  className="img-fluid rounded w-100 object-fit-contain"
                  data-bs-wow-delay="0.3s"
                  src={"/assets/img/gallery/IMG_5376.webp"}
                />
              </div>
            </div>
          ...
          <div className="col-md-6 bg-dark rounded mt-1 p-1">
            <div className="px-2 py-2 px-md-5 py-md-4">
              ...
              <h1 className="text-white mb-4">Relax in Spacious Luxury Room</h1>
              <p className="text-white mb-4">
                Indulge in sophistication with spacious rooms that boast stylish
                interiors, high-end finishes, and all the conveniences for a
                perfect stay.
              </p>
              <Link
                href={"/contact-us"}
              ...
              <BtnBookThisRoom roomid={"2"} key={2} roomdata={roomdata} />
            </div>
          </div>
        </div>
      </div>
