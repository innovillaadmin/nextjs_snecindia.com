...
export default function RoomSlider2() {
  ...
  return (
    <div className="container-fluid pt-3 pb-3">
      <h2 className="fs-1 bebas-neue-regular text-center py-5">Room 3</h2>
          ...
          <div className="col-md-6 bg-dark rounded mt-1 p-1 order-2 order-md-1">
            <div className="px-2 py-2 px-md-5 py-md-4">
              ...
              <h1 className="text-white mb-4">
                Indulge in Sophisticated Style
              </h1>
              <p className="text-white mb-4">
                Each room is a sanctuary of comfort, featuring premium
                furnishings, state-of-the-art technology, and a refined ambiance
                for a restful stay.
              </p>
              <Link
                href={"/contact-us"}
              ...
              <BtnBookThisRoom roomid={"3"} key={3} roomdata={roomdata} />
            </div>
          </div>
            ...
            >
              <div className="border  keen-slider__slide rounded number-slide3 ">
                ...
                <Image
                  ...
                  src="/assets/img/gallery/IMG_5352.webp"
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide1">
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src="/assets/img/gallery/IMG_5348.webp"
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide2 ">
                ...
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src="/assets/img/gallery/IMG_5349.webp"
                />
              </div>
              ...
              <div className="border  keen-slider__slide rounded number-slide4 ">
                ...
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src="/assets/img/gallery/IMG_5355.webp"
                />
              </div>
            </div>
