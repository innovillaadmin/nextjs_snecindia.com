...
export default function RoomSlider1() {
  ...
  return (
    <div className="container-fluid pt-3 pb-3" id="roomid1">
      <h1 className="bebas-neue-regular text-center py-5">Room 1</h1>
        ...
        <div className="row m-0">
            ...
            >
              <div className="border  keen-slider__slide rounded number-slide1">
                <Image
                  ...
                  src={"/assets/img/gallery/IMG_5379.webp"}
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide2 ">
                ...
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src={"/assets/img/gallery/IMG_5380.webp"}
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide3 ">
                ...
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src={"/assets/img/gallery/IMG_5382.webp"}
                />
              </div>
              <div className="border  keen-slider__slide rounded number-slide4 ">
                ...
                <Image
                  ...
                  className="img-fluid rounded w-100 object-fit-cover"
                  data-bs-wow-delay="0.3s"
                  src={"/assets/img/gallery/IMG_5384.webp"}
                />
              </div>
            </div>
          ...
          <div className="col-md-6 bg-dark rounded mt-1 p-1">
            <div className="px-2 py-2 px-md-5 py-md-4">
              ...
              <h1 className="text-white mb-4">Unwind in Elegant Comfort</h1>
              <p className="text-white mb-4">
                Experience luxury in every detail with elegant decor, plush
                bedding, and modern amenities that create a serene retreat in
                every room.
              </p>
              <Link
                href={"/contact-us"}
              ...
              <BtnBookThisRoom roomid={"1"} key={1} roomdata={roomdata} />
            </div>
          </div>
        </div>
      </div>
