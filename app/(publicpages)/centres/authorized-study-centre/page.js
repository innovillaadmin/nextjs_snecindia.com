      ...
      <div className="container py-5">
        ...
        <div className="row mb-4">
          <div className="col text-center">
            <h1 className="display-5 fw-bold">Authorized Study Centre List</h1>
            <p className="lead text-muted">
              Below is the list of newly registered and upcoming SSNEC Study
              Centre centres across India.
            </p>
          </div>
        </div>
